...
const logConfigs: LogConfig[] = [
  { regExp: "Services.WebService", logLevel: LogLevel.Error },
  { regExp: "Services.+", logLevel: LogLevel.Info },
  { regExp: "Utils.BoardShortPolling", logLevel: LogLevel.Info },
  { regExp: "Components.GameStatus", logLevel: LogLevel.Info },
  { regExp: "Components.Game", logLevel: LogLevel.Info },
